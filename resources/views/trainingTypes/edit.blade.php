                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="form-group col-md-6">
                                                      <label for="training_description"><span class="text-danger">*</span> TRAINING DESCRIPTION</label>
                                                            ...
                                                            <input type="text" class="form-control {{ $errors->has('training_description') ? ' is-invalid' : '' }}" value="{{$trainingType['training_description']}}" id="training_description" placeholder="Enter training description" name="training_description" autocomplete="off">
